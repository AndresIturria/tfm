...
# ----------------------------- #
model.save("resnet50_finetuned_fish_species_split.keras")
print("Model saved as 'resnet50_finetuned_fish_species_split.keras'")
...
plt.tight_layout()
plt.savefig('loss_accuracy_resnet50.png')
print("Loss and accuracy graphs saved as 'loss_accuracy_resnet50.png'")
plt.show()
