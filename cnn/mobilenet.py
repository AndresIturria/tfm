...
with open("graphs/training_report_mobilenet.txt", "w") as f:
...
print("Training report saved as 'training_report_mobilenet.txt'")


# ----------------------------- #
# SAVE MODEL
# ----------------------------- #
model.save("models/mobilenetv2_finetuned_fish_species_split.keras")
print("Model saved as 'mobilenetv2_finetuned_fish_species_split.keras'")
...
plt.title('Loss per Epoch (MobileNetV2)')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
...
plt.title('Accuracy per Epoch (MobileNetV2)')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()

plt.tight_layout()
plt.savefig('graphs/loss_accuracy_mobilenetv2.png')
print("Loss and accuracy graphs saved as 'loss_accuracy_mobilenetv2.png'")
plt.show()
...
plt.tight_layout()
plt.savefig('graphs/confusion_matrix_mobilenetv2.png')
print("Confusion matrix saved as 'confusion_matrix_mobilenetv2.png'")
plt.show()
