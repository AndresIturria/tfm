...
# ----------------------------- #
model.save("models/resnet152_finetuned_fish_species_split.keras")
print("Model saved as 'resnet152_finetuned_fish_species_split.keras'")
...
plt.tight_layout()
plt.savefig('graphs/loss_accuracy_resnet152.png')
print("Loss and accuracy graphs saved as 'loss_accuracy_resnet152.png'")
plt.show()
...
plt.tight_layout()
plt.savefig('graphs/confusion_matrix_resnet152.png')
print("Confusion matrix saved as 'confusion_matrix_resnet152.png'")
plt.show()
...
with open("graphs/training_report_resnet.txt", "w") as f:
...
print("Training report saved as 'training_report_resnet.txt'")